...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.robmelfi.rcraspi.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.robmelfi.rcraspi.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.robmelfi.rcraspi.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.robmelfi.rcraspi.domain.Authority.class.getName(), jcacheConfiguration);
