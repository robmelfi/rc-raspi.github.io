...
export class ControllerDeleteDialog extends React.Component<IControllerDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.controllerEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="rcraspiApp.controller.delete.question">
          <Translate contentKey="rcraspiApp.controller.delete.question" interpolate={{ id: controllerEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-controller" color="danger" onClick={this.confirmDelete}>
